...
export default function Projects() {
  ...
  return (
    <>
      <NextSeo
        title="Projects - Max Vresch"
        description={siteMeta.description}
        canonical="https://maxvresch.com/projects"
        openGraph={{
          url: "https://maxvresch.com/projects",
          images: [
            {
              url: `https://${siteMeta.siteUrl}/api/og?title=Projects&desc=${headline}`,
              width: 1200,
              height: 600,
              alt: "Og Image Alt",
              type: "image/jpeg",
