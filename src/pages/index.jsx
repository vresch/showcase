...
function Resume() {
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button href="https://linkedin.com/in/vresch" variant="secondary" className="group mt-6 w-full">
        More on LinkedIn
    ...
    <>
      <NextSeo
        ...
        openGraph={{
          ...
          images: [
            {
              url: `https://${siteMeta.siteUrl}/api/og?title=${siteMeta.title}&desc=${siteMeta.description}`,
              width: 1200,
              height: 600,
              alt: "Og Image Alt",
              type: "image/jpeg",
      ...
      <Container className="mt-9">
        <div className="max-w-2xl text-lg">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
            Web3 Advocate, hacker, and open source enthusiast.
          </h1>
          <p className="prose mt-6 dark:prose-invert">
            I’m Max, and I teach people how to build dApps. I’ve been active in Open Source for as long as I’ve been
            coding &mdash; and that’s a long time.
          </p>
          <div className="mt-6 flex gap-6">
            <SocialLink href={siteMeta.author.twitter} aria-label="Follow on Twitter" icon={TwitterIcon} />
            <SocialLink href={siteMeta.author.instagram} aria-label="Follow on Instagram" icon={InstagramIcon} />
            <SocialLink href={siteMeta.author.github} aria-label="Follow on GitHub" icon={GitHubIcon} />
            <SocialLink href={siteMeta.author.linkedin} aria-label="Follow on LinkedIn" icon={LinkedInIcon} />
          </div>
        </div>
      </Container>
      <Photos />
